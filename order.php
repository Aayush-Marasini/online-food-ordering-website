...
<script type="text/javascript">
    ...
    function place(){
        ...
        // Redirect to placeorder.php with address parameter
        window.location.href='placeorder.php?item='+items+'&total='+total+'&address='+address;
    }
    function Order(name){
...
<body>
    ...
    <div class="container">
        ...
        <!-- Add the address field in your HTML form -->
