	...
	<div class="container">
		...
		<div class="filters col-sm-2">
			...
			<ul>
				...
				<li><button onclick="cuisine('Indian')" style="border: none; background-color: #fff; cursor: pointer; color:blue;">Indian</button></li>
			    ...
			    <div class="modal-dialog">
			      <div class="modal-content">
			        <div class="modal-header"  style="background-color: red; color: #fff;">
			          <h4 class="modal-title">SignUp to OurFood</h4>
			        </div>
		...
		<form method="post" action="logsignup/login.php">
			<div class="modal fade" id="login" role="dialog">
			    <div class="modal-dialog">
			      <div class="modal-content">
			        <div class="modal-header"  style="background-color: red; color: #fff;">
			          <h4 class="modal-title">Login to OurFood</h4>
			        </div>
			        <div class="modal-body">
			          <div class="form-group">
			          	<label>Email</label>
