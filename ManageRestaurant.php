...
$restname = str_replace(' ', '_', $rest_name); // Modify table name construction
$restname = str_replace('-', '_', $restname); // Additional replacement to handle hyphens
...
if (isset($_POST['addcuisine'])) {
    ...
    if (!mysqli_query($conn, $insertdish)) {
        die("Query failed: " . mysqli_error($conn));
    }
